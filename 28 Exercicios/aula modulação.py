...
if tturno = input("Em que turno você estuda? para M-Matutino, V-Vespertino e N-Noturno:")
...
while opçao != 0:
        ...
        print("Escolha um opçao abaixo:")
        print("1-digite seu turno")
        print("2- culcule seu salario")
        opçao=int(input("Digite uma das opçoes ou 0 para sair:"))
        if opçao == 1:
            print("---iniciando funçao turno---")
            turno()
        elif opçao == 2:  
            print("---inciando funçao calculo de salario---")
            salario()

 #chamar funçao de menu
menu()
